...
# This file finds every image tile of every unique tile in a given sequence and prime.
...
# Function finds the tiles of minimum length such that the sequence seq is generated by a 
